...
_**Use relative paths from ```output_dir``` if using Docker**_
```
...
- append_annotations - add triad filter option (or strict homeolog filter between pairs), add message stating if files exist they were skipped
