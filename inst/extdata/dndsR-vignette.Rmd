# Needs updating with test set before being built in vignettes/
...
split_comparisons(
  ...
  mode = "subgenome"   # Chr1A / chr03_b → labels A,B,...
)
```
...
go_enrichment(
  ...
  node_min = 5,                 # drop ultra-rare terms
  #node_max = 2000,             # optional upper cap
  make_plots = TRUE,
  top_n = 20,
  #exclude_gos = "GO:0015074",
...
ipr_enrichment(
  ...
  #fdr_method = "IHW",
  pos_threshold = 1.1
  #interpro_release = "83.0"
  #exclude_ids = "IPR000109"
)
